...
export default function Banner() {
  return (
    <div className=" hidden sm:flex rounded-lg flex-col items-end gap-5 absolute top-1/2 left-1/2 backdrop-blur-sm bg-white/10 font-handfree  text-white py-6 px-7">
